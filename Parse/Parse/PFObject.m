...
- (BOOL)resolveLocalId:(NSError *__autoreleasing*)error {
    @synchronized (lock) {
        PFPreconditionBailAndSetError(self.localId, error, NO , @"Tried to resolve a localId for an object with no localId.");
        ...
        // be possible.
        PFPreconditionBailAndSetError(newObjectId, error, NO , @"Tried to save an object with a pointer to a new, unsaved object.");
